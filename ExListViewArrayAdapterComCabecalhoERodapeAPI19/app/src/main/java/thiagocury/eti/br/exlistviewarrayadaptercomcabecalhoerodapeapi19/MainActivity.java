package thiagocury.eti.br.exlistviewarrayadaptercomcabecalhoerodapeapi19;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCabecalho = (TextView) findViewById(R.id.lv_contato_cabecalho);
        tvRodape = (TextView) findViewById(R.id.lv_contato_rodape);

        //Deixando o cabeçalho e rodapé invisível.
        tvCabecalho.setVisibility(View.INVISIBLE);
        tvRodape.setVisibility(View.INVISIBLE);
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!etNome.getText().toString().isEmpty()) {
                    ...
                    //Deixando o cabeçalho e rodapé visível.
                    tvCabecalho.setVisibility(View.VISIBLE);
                    tvRodape.setVisibility(View.VISIBLE);
